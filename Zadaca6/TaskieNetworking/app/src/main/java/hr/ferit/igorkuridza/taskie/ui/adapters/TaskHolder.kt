...
import hr.ferit.igorkuridza.taskie.common.convertPriority
...
class TaskHolder(override val containerView: View) : RecyclerView.ViewHolder(containerView), LayoutContainer {
    ...
    fun bindData(task: BackendTask, onItemSelected: (BackendTask) -> Unit) {
        ...
        DrawableCompat.setTint(wrapDrawable, ContextCompat.getColor(containerView.context, convertPriority(task.taskPriority).getColor()))
    }
}